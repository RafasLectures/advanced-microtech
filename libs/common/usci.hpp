...
static constexpr volatile uint8_t *usci_a_registers[][9] = {
    ...
    {&UCA1CTL0, &UCA1CTL1, &UCA1BR0, &UCA1BR1, &UCA1MCTL, &UCA1STAT,
        const_cast<uint8_t *>(&UCA1RXBUF), &UCA1TXBUF, 0}
#endif
};

static constexpr volatile uint16_t *usci_a_registers_addr[][2] = {
                                                                {0, 0},
#ifdef UCA1CTL0_
                                                                {0, 0}
#endif
...
static constexpr volatile uint8_t *usci_b_registers[][9] = {
    ...
    {&UCB1CTL0, &UCB1CTL1, &UCB1BR0, &UCB1BR1, 0, &UCB1STAT,
        const_cast<uint8_t *>(&UCB1RXBUF), &UCB1TXBUF, &UCB1I2CIE}
#endif
};

static constexpr volatile uint16_t *usci_b_registers_addr[][2] = {
                                                                {&UCB0I2COA, &UCB0I2CSA},
#ifdef UCB1CTL0_
                                                                {&UCB1I2COA, &UCB1I2CSA}
#endif
